...
public class Towers extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/project/automatatheoryproject/TowersPage.fxml"));
    ...
    private void handleShowMoves() {
        ...
        // Add a ScrollPane to make the moves list scrollable
        ScrollPane scrollPane = new ScrollPane(movesArea);
